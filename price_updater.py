...
class PriceUpdater(object):
    def __init_(self, spreadsheet_name):
        self.item_col = 1
        self.price_col = 2
        self.frequence_col = 3
        self.url_col = 4
    ...
    def update_spreadsheet_price(self):
        ...
        for i in range(1, len(urls)):
            ...
            print("Updating item {self.sheet.cell(i+1, self.item_col).value} from Amazon listing {product_name} with price {product_price}")
